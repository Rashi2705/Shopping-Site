...
Query q=s.createQuery("from Product_Details p where p.category=:cat").setParameter("cat","Footwear");
...
for(Product_Details product:list){
 ...
 <form action="Perticular_page_controller" method="post">
   ...
   <button type="submit" style="border:none; background-color:white" href="#">        <img src= "http://localhost:8080/sellerUploads/<%= product.getSimagename() %>" alt="clothing" class ="pimg"/> </button></form>
