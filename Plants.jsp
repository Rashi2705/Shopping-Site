...
Query q=s.createQuery("from Product_Details p where p.category=:cat").setParameter("cat","plants");
...
for(Product_Details product:list){
   ...
   <button type="submit"   style="border:none; background-color:white">       <img src="http://localhost:8080/sellerUploads/<%= product.getSimagename() %>" alt="clothing" class ="pimg"/> </button></form>
