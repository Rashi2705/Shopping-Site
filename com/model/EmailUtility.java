	 ...
	 private static final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
	  ...
	  private static Properties props = new Properties();
	   static {
		...
		public static void sendEmail(EmailMessage emailMessageDTO) {
			JavaBase64 secure=new JavaBase64();
			final String sender_Email  = "poojamanethiya80@gmail.com";
        	final String sender_pass  = "cG9vamFtOTdAIw==";
        	final String sender_email_pass  = secure.Decrypt(sender_pass) ;
		        try {
