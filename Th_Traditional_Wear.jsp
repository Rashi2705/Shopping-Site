...
Query q=s.createQuery("from Thrift_product p where p.category=:cat").setParameter("cat","Traditionalwear");
...
for(Thrift_product product:list){
   ...
   <button type="submit" href="#"  style="border:none; background-color:white">  
