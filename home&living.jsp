...
Query q=s.createQuery("from Product_Details p where p.category=:cat").setParameter("cat","homeandliving");
...
for(Product_Details product:list){
   ...
   <button type="submit" href="#"  style="border:none; background-color:white">       <img src= "http://localhost:8080/sellerUploads/<%= product.getSimagename() %>" alt="clothing" class ="pimg"/> </button></form>
