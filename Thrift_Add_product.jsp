...
resize:none;
  width: 95%;
    ...
    <script type="text/javascript">
        var subcategory = {
       Topsandtees: ["Men", "Women", "Kids"]  ,    
        Books: ["Books"] ,
        homeandliving: ["Furniture","Others"] ,
        Traditionalwear:["Men", "Women", "Kids","Others"],
        Handicraft:["Others"],
        Jeans:["Men", "Women", "Kids"],
        Stationary:["Books","Others"],
        Dresses:["Women", "Kids","Others"],
        Others: ["Furniture","Others"] 
        }
...
<section class="usr" style="margin-top:15%">
   ...
   <div>  <p> Sell At Main Page </p> 
    ...
    <div > <p> Sell At thrift Store</p>
      <a href="Thrift_Add_product.jsp">Add Products</a><br></br></div>
    ...
    <div class = "profileright">  
               <form   action="Thrift_Id_Controller" method="post" enctype ="multipart/form-data">
             <div class="container">
...
<footer style="margin-top:77%"><%@ include file= "ftr.jsp" %></footer>
</body>
</html>